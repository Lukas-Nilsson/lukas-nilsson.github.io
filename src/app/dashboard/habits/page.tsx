                    ...
                    {chartData.length > 1 && (
                        <div className={styles.widget}>
                            ...
                            <BarChart
                                ...
                                xKey="date"
                                height={160}
                                bars={[{ key: 'Score', color: 'var(--accent-400)', name: 'Discipline Score' }]}
                                yDomain={[0, 100]}
                                unit="%"
                            />
                            <p style={{ fontSize: 'var(--text-xs)', color: 'var(--color-text-muted)', maxWidth: 'none' }}>
                                Discipline score reflects how early in the day tasks were completed.
                            </p>
                        </div>
                    )}
                    ...
                    <div className={styles.widget}>
                        ...
                        <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 'var(--space-2)' }}>
                            {[...history].reverse().map(d => (
                                <li key={d.date} style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-3)', padding: 'var(--space-2) 0', borderBottom: '1px solid var(--color-border)', fontSize: 'var(--text-sm)' }}>
                                    ...
                                    <span style={{ flex: 1 }}>{shortDate(d.date)}</span>
                                    <span style={{ color: 'var(--color-text-muted)', fontSize: 'var(--text-xs)' }}>
                                        {d.discipline_score ? `${d.discipline_score}% discipline` : ''}
                                    </span>
                                </li>
                            ))}
                        </ul>
